...
@interface TestTTSViewController () <IDRBaseLocationServerDelegate, WKScriptMessageHandler, WKNavigationDelegate, WKUIDelegate>
...
@implementation TestTTSViewController
...
- (void)setupWebview {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://10.90.25.46:8087/"];
...
- (void)startTestBeacons {
    ...
    __weak TestTTSViewController *weakSelf = self;
